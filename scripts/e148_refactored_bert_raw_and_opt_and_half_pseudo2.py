...
MODEL_CONFIG_PATH = './mnt/datasets/model_configs/bert-model-uncased-config-hidden.pkl'
TOKENIZER_TYPE = 'bert'
...
def main(args, logger):
    ...
    raw_pseudo_df = pd.read_csv('./mnt/inputs/pseudos/top2_e121_e125_e126_e127_e128_e129/raw_pseudo_tst_df.csv')
    half_opt_pseudo_df = pd.read_csv('./mnt/inputs/pseudos/top2_e121_e125_e126_e127_e128_e129/half_opt_pseudo_tst_df.csv')
    opt_pseudo_df = pd.read_csv('./mnt/inputs/pseudos/top2_e121_e125_e126_e127_e128_e129/opt_pseudo_tst_df.csv')
