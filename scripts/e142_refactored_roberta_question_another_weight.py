...
MNT_DIR = './mnt'
DEVICE = 'cuda'
MODEL_PRETRAIN = 'roberta-base-openai-detector'
MODEL_CONFIG_PATH = './mnt/datasets/model_configs/roberta-model-openai-config.pkl'
TOKENIZER_TYPE = 'roberta'
TOKENIZER_PRETRAIN = 'roberta-base-openai-detector'
BATCH_SIZE = 8
MAX_EPOCH = 6
MAX_SEQ_LEN = 512
T_MAX_LEN = 30
